...
public class ImageCaptureClass extends Activity {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == CAMERA_CAPTURE_IMAGE_REQUEST_CODE) {
			if (resultCode == RESULT_OK) {
				...
				SetImageMetadataClass setImageMetadataClass = new SetImageMetadataClass(
						imageUrl, latitude, longitude);
				setImageMetadataClass.loc2Exif(imageUrl, latitude, longitude);

				Toast.makeText(getApplicationContext(), imageUrl,
						Toast.LENGTH_LONG).show();
				...
				alertDialogBuilder
						.setMessage("")
						.setCancelable(false)
						.setPositiveButton("Upload Now",
								new DialogInterface.OnClickListener() {
									public void onClick(DialogInterface dialog,
											int id) {
										Intent intent = new Intent(
												ImageCaptureClass.this,
												UploadPhotoClass.class);
						...
						.setNegativeButton("Upload Later",
								new DialogInterface.OnClickListener() {
									public void onClick(DialogInterface dialog,
											int id) {
										...
										Intent upload_later_intent=new Intent(ImageCaptureClass.this,MainMenuClass.class);
										startActivity(upload_later_intent);
									}
								});
				// create alert dialog
	...
	private File getOutputMediaFile(int type) {
		...
		if (type == MEDIA_TYPE_IMAGE) {
			...
			imageUrl = mediaStorageDir.getPath() + File.separator + "IMG_"
					+ timeStamp + ".jpg";
